(() => {
  ...
  var unsafeReadProp = function(dictMonad) {
    ...
    return function(k) {
      return function(value12) {
        return unsafeReadPropImpl(fail2(new TypeMismatch("object", typeOf(value12))), pure10, k, value12);
      };
    };
  };
  ...
  var State2 = /* @__PURE__ */ function() {
    ...
    ;
    State3.value = new State3();
    return State3;
  }();
  var State22 = /* @__PURE__ */ function() {
    function State23() {
    }
    ;
    State23.value = new State23();
    return State23;
  }();
  ...
  var ValidateCode = /* @__PURE__ */ function() {
    function ValidateCode2(value0) {
      this.value0 = value0;
    }
    ;
    ValidateCode2.create = function(value0) {
      return new ValidateCode2(value0);
    };
  ...
  var SendForm = /* @__PURE__ */ function() {
    ...
    ;
    SendForm3.value = new SendForm3();
    return SendForm3;
  }();
  var SendForm2 = /* @__PURE__ */ function() {
    function SendForm22() {
    }
    ;
    SendForm22.value = new SendForm22();
    return SendForm22;
  }();
  var GoNext = /* @__PURE__ */ function() {
    ...
    ;
    GoNext2.value = new GoNext2();
    return GoNext2;
  }();
  var mkQuestion = function(label5) {
    return function(innerHtml) {
      return div2([class_("question")])([text(label5), br_, innerHtml, br_]);
    };
  };
  ...
  var handleQuery = function(dictMonadEffect) {
    return function(v) {
      return bind3(get2)(function(state3) {
        return pure5(new Just(v.value0(state3)));
      });
    };
  };
  var eventHandler = function(dictMonadEffect) {
    var liftEffect7 = liftEffect(monadEffectHalogenM(dictMonadEffect));
    return function(v) {
      if (v instanceof ValidateCode) {
        return discard2(liftEffect7(preventDefault(v.value0)))(function() {
      ...
      if (v instanceof SendForm) {
        return modify_3(function(v1) {
          return State22.value;
        });
      }
      ;
      if (v instanceof SendForm2) {
        return modify_3(function(v1) {
          return State2.value;
        });
      }
      ;
      if (v instanceof GoNext) {
        return raise(Submitted.value);
      }
      ;
  ...
  var ageQuestion = /* @__PURE__ */ function() {
    return mkQuestion("Edad")(input([type_4(InputNumber.value), id2("age"), name2("participant[age]"), required(true), onValueInput(function(v) {
      return SendForm.value;
    })]));
  }();
  var renderQuestionsForm = /* @__PURE__ */ function() {
    return form([id2("participant_form"), onSubmit(function(ev) {
      return new ValidateCode(ev);
    })])([ageQuestion, input([type_4(InputSubmit.value), title("Siguiente")])]);
  }();
  var renderQuestions = function(state3) {
    if (state3 instanceof State2) {
      return renderQuestionsForm;
    }
    ;
    if (state3 instanceof State22) {
  ...
  var questionsComponent = function(dictMonadEffect) {
    return mkComponent({
      ...
      "eval": mkEval({
        ...
        handleAction: eventHandler(dictMonadEffect),
  ...
  var mainHandler = function(dictMonadEffect) {
    return function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Coordinator (line 57, column 15 - line 62, column 39): " + [v.constructor.name]);
    };
  };
  ...
  var render = function(dictMonadEffect) {
    var questionsComponent2 = questionsComponent(dictMonadEffect);
    return function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Coordinator (line 48, column 10 - line 54, column 25): " + [v.constructor.name]);
    };
  };
  var mainComponent = function(dictMonadEffect) {
    return mkComponent({
      ...
      "eval": mkEval({
        ...
        initialize: defaultEval.initialize,
        finalize: defaultEval.finalize,
        handleAction: mainHandler(dictMonadEffect)
      })
    });
  };
  ...
  var mainComponent2 = /* @__PURE__ */ mainComponent(monadEffectAff);
